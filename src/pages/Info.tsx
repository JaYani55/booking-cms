...
const Info = () => {
  ...
  // Filter FAQs by question or answer text
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <h1 id="faq-heading" className="text-4xl font-extrabold mb-6 text-center">
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            className={`
              w-full pl-10 pr-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2
              transition-colors
              ${theme === 'dark'
        ...
        {filteredFaqs.length === 0 ? (
          ...
          <div className="space-y-6">
            {filteredFaqs.map(({ id, question, answer }) => (
              <div
                key={id}
                className={`border rounded-lg p-5 ${theme === 'dark' ? 'bg-gray-800 border-gray-700 text-gray-100' : 'bg-gray-100 border-gray-200 text-gray-900'}`}
              >
